...
#define PM_QOS_BIG_FREQ_MIN_DEFAULT_VALUE	0
#define PM_QOS_BIG_FREQ_MAX_DEFAULT_VALUE	INT_MAX
#define PM_QOS_LITTLE_FREQ_MIN_DEFAULT_VALUE	0
#define PM_QOS_LITTLE_FREQ_MAX_DEFAULT_VALUE	INT_MAX
