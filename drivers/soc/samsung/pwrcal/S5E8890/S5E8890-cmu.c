...
static struct pwrcal_pll_rate_table mngs_pll_rates[] = {
	PLL_RATE_MPS(2496*MHZ,	288,	3,	0),
	PLL_RATE_MPS(2392*MHZ,	276,	3,	0),
	PLL_RATE_MPS(2288*MHZ,	264,	3,	0),
	PLL_RATE_MPS(2184*MHZ,	252,	3,	0),
	PLL_RATE_MPS(2080*MHZ,	240,	3,	0),
	PLL_RATE_MPS(1976*MHZ,	228,	3,	0),
	PLL_RATE_MPS(1872*MHZ,	216,	3,	0),
	PLL_RATE_MPS(1768*MHZ,	204,	3,	0),
	PLL_RATE_MPS(1664*MHZ,	192,	3,	0),
	PLL_RATE_MPS(1560*MHZ,	360,	3,	1),
	PLL_RATE_MPS(1456*MHZ,	336,	3,	1),
	PLL_RATE_MPS(1352*MHZ,	312,	3,	1),
	PLL_RATE_MPS(1248*MHZ,	288,	3,	1),
	PLL_RATE_MPS(1144*MHZ,	264,	3,	1),
	PLL_RATE_MPS(1040*MHZ,	240,	3,	1),
	PLL_RATE_MPS(936*MHZ,	216,	3,	1),
	PLL_RATE_MPS(832*MHZ,	192,	3,	1),
	PLL_RATE_MPS(728*MHZ,	336,	3,	2),
	PLL_RATE_MPS(624*MHZ,	288,	3,	2),
	PLL_RATE_MPS(520*MHZ,	240,	3,	2),
	PLL_RATE_MPS(416*MHZ,	192,	3,	2),
	PLL_RATE_MPS(312*MHZ,	288,	3,	3),
	PLL_RATE_MPS(208*MHZ,	192,	3,	3),
};

static struct pwrcal_pll_rate_table apollo_pll_rates[] = {
	PLL_RATE_MPS(1976*MHZ,	228,	3,	0),
	PLL_RATE_MPS(1898*MHZ,	219,	3,	0),
	PLL_RATE_MPS(1794*MHZ,	207,	3,	0),
	PLL_RATE_MPS(1690*MHZ,	195,	3,	0),
	PLL_RATE_MPS(1586*MHZ,	183,	3,	0),
	PLL_RATE_MPS(1482*MHZ,	171,	3,	0),
	PLL_RATE_MPS(1378*MHZ,	159,	3,	0),
	PLL_RATE_MPS(1274*MHZ,	147,	3,	0),
	PLL_RATE_MPS(1170*MHZ,	135,	3,	0),
	PLL_RATE_MPS(1066*MHZ,	123,	3,	0),
	PLL_RATE_MPS(962*MHZ,	222,	3,	1),
	PLL_RATE_MPS(858*MHZ,	198,	3,	1),
	PLL_RATE_MPS(754*MHZ,	174,	3,	1),
	PLL_RATE_MPS(650*MHZ,	150,	3,	1),
	PLL_RATE_MPS(546*MHZ,	126,	3,	1),
	PLL_RATE_MPS(442*MHZ,	204,	3,	2),
	PLL_RATE_MPS(338*MHZ,	156,	3,	2),
	PLL_RATE_MPS(234*MHZ,	216,	3,	3),
	PLL_RATE_MPS(130*MHZ,	120,	3,	3),
};

static struct pwrcal_pll_rate_table mif_pll_rates[] = {
	PLL_RATE_MPS(3692*MHZ,	213,	3,	0),
	PLL_RATE_MPS(3484*MHZ,	201,	3,	0),
	PLL_RATE_MPS(3120*MHZ,	180,	3,	0),
	PLL_RATE_MPS(2964*MHZ,	171,	3,	0),
	PLL_RATE_MPS(2704*MHZ,	156,	3,	0),
	PLL_RATE_MPS(2444*MHZ,	141,	3,	0),
	PLL_RATE_MPS(2184*MHZ,	126,	3,	0),
	PLL_RATE_MPS(1924*MHZ,	111,	3,	0),
	PLL_RATE_MPS(1664*MHZ,	192,	3,	1),
	PLL_RATE_MPS(1352*MHZ,	156,	3,	1),
	PLL_RATE_MPS(1144*MHZ,	132,	3,	1),
	PLL_RATE_MPS(832*MHZ,	192,	3,	2),
	PLL_RATE_MPS(572*MHZ,	132,	3,	2),
	PLL_RATE_MPS(416*MHZ,	192,	3,	3),
};

static struct pwrcal_pll_rate_table bus0_pll_rates[] = {
	PLL_RATE_MPS(1056*MHZ,	528,	13,	0),
};

static struct pwrcal_pll_rate_table bus1_pll_rates[] = {
	PLL_RATE_MPS(800*MHZ,	400,	13,	0),
};

static struct pwrcal_pll_rate_table bus2_pll_rates[] = {
	PLL_RATE_MPS(672*MHZ,	336,	13,	0),
};

static struct pwrcal_pll_rate_table bus3_pll_rates[] = {
	PLL_RATE_MPS(1872*MHZ,	288,	4,	0),
};

static struct pwrcal_pll_rate_table g3d_pll_rates[] = {
	PLL_RATE_MPS(780*MHZ,	120,	4,	0),
	PLL_RATE_MPS(702*MHZ,	108,	4,	0),
	PLL_RATE_MPS(598*MHZ,	184,	4,	1),
	PLL_RATE_MPS(546*MHZ,	168,	4,	1),
	PLL_RATE_MPS(416*MHZ,	128,	4,	1),
	PLL_RATE_MPS(351*MHZ,	108,	4,	1),
	PLL_RATE_MPS(273*MHZ,	168,	4,	2),
	PLL_RATE_MPS(169*MHZ,	104,	4,	2),
	PLL_RATE_MPS(104*MHZ,	128,	4,	3),
};

static struct pwrcal_pll_rate_table mfc_pll_rates[] = {
	PLL_RATE_MPS(1196*MHZ,	184,	4,	0),
};

static struct pwrcal_pll_rate_table disp_pll_rates[] = {
	PLL_RATE_MPS(62500000,	500,	13,	4),
	PLL_RATE_MPS(35500000,	568,	13,	5),
	PLL_RATE_MPS(61500000,	492,	13,	4),
	PLL_RATE_MPS(62000000,	496,	13,	4),
	PLL_RATE_MPS(63000000,	504,	13,	4),
	PLL_RATE_MPS(63500000,	508,	13,	4),
	PLL_RATE_MPS(64000000,	512,	13,	4),
	PLL_RATE_MPS(64500000,	516,	13,	4),
	PLL_RATE_MPS(65000000,	520,	13,	4),
	PLL_RATE_MPS(66000000,	528,	13,	4),
	PLL_RATE_MPS(67000000,	536,	13,	4),
	PLL_RATE_MPS(68000000,	544,	13,	4),
	PLL_RATE_MPS(69000000,	552,	13,	4),
	PLL_RATE_MPS(70000000,	560,	13,	4),
	PLL_RATE_MPS(71000000,	568,	13,	4),
	PLL_RATE_MPS(71500000,	572,	13,	4),
	PLL_RATE_MPS(72000000,	576,	13,	4),
	PLL_RATE_MPS(73000000,	584,	13,	4),
	PLL_RATE_MPS(74000000,	592,	13,	4),
	PLL_RATE_MPS(75000000,	600,	13,	4),
	PLL_RATE_MPS(76000000,	608,	13,	4),
	PLL_RATE_MPS(77000000,	616,	13,	4),
	PLL_RATE_MPS(78000000,	624,	13,	4),
	PLL_RATE_MPS(79000000,	632,	13,	4),
	PLL_RATE_MPS(80000000,	640,	13,	4),
	PLL_RATE_MPS(81000000,	648,	13,	4),
	PLL_RATE_MPS(37340000,	597,	13,	5),
	PLL_RATE_MPS(41882000,	232,	9,	4),
	PLL_RATE_MPS(42900000,	132,	5,	4),
	PLL_RATE_MPS(86554000,	293,	11,	3),
	PLL_RATE_MPS(96811000,	268,	9,	3),
	PLL_RATE_MPS(156228000,	168,	7,	2),
	PLL_RATE_MPS(174289000,	295,	11,	2),
	PLL_RATE_MPS(178244000,	192,	7,	2),
	PLL_RATE_MPS(356488000,	192,	7,	1),
	PLL_RATE_MPS(32011000,	197,	5,	5),
	PLL_RATE_MPS(35554000,	350,	8,	5),
	PLL_RATE_MPS(36000000,	576,	13,	5),
	PLL_RATE_MPS(69326000,	256,	6,	4),
	PLL_RATE_MPS(77064000,	166,	7,	3),
	PLL_RATE_MPS(120850000,	409,	11,	3),
	PLL_RATE_MPS(134314000,	248,	6,	3),
	PLL_RATE_MPS(134314000,	248,	6,	3),
	PLL_RATE_MPS(133320000,	287,	7,	3),
	PLL_RATE_MPS(266640000,	287,	7,	2),
};

static struct pwrcal_pll_rate_table isp_pll_rates[] = {
	PLL_RATE_MPS(819*MHZ,	126,	4,	0),
};


static struct pwrcal_pll_rate_table aud_pll_rates[] = {
	PLL_RATE_MPSK(589824000,	45,	1,	1,	24319),
	PLL_RATE_MPSK(491520000,	38,	1,	1,	-12502),
	PLL_RATE_MPSK(196608000,	30,	1,	2,	16213),
	PLL_RATE_MPSK(492000000,	38,	1,	1,	-10082),
	PLL_RATE_MPSK(592000000,	46,	1,	1,	-30247),
	PLL_RATE_MPSK(32768000,		40,	1,	5,	21617),
	PLL_RATE_MPSK(45158400,		28,	1,	4,	-13777),
	PLL_RATE_MPSK(49152000,		30,	1,	4,	16213),
	PLL_RATE_MPSK(67737600,		42,	1,	4,	-20665),
	PLL_RATE_MPSK(73728000,		45,	1,	4,	24319),
	PLL_RATE_MPSK(98304000,		30,	1,	3,	24319),
	PLL_RATE_MPSK(147456000,	45,	1,	3,	24319),
	PLL_RATE_MPSK(196608000,	30,	1,	2,	16213),
	PLL_RATE_MPSK(294912000,	45,	1,	2,	24319),
};
...
CLK_PLL(14160,	MNGS_PLL,	0,	MNGS_PLL_LOCK,	MNGS_PLL_CON0,	mngs_pll_rates,	MNGS_MUX_MNGS_PLL,	&pll141xx_ops);
CLK_PLL(14170,	APOLLO_PLL,	0,	APOLLO_PLL_LOCK,	APOLLO_PLL_CON0,	apollo_pll_rates,	APOLLO_MUX_APOLLO_PLL,	&pll141xx_ops);
CLK_PLL(14180,	G3D_PLL,	0,	G3D_PLL_LOCK,	G3D_PLL_CON0,	g3d_pll_rates,	G3D_MUX_G3D_PLL_USER,	&pll141xx_ops);
CLK_PLL(14190,	MIF_PLL,	0,	MIF0_PLL_LOCK,	MIF_CLK_CTRL0,	mif_pll_rates,	TOP_MUX_MIF_PLL,	&pll1419x_ops);
CLK_PLL(14180,	BUS0_PLL,	0,	BUS0_PLL_LOCK,	BUS0_PLL_CON0,	bus0_pll_rates,	TOP_MUX_BUS0_PLL,	&pll141xx_ops);
CLK_PLL(14180,	BUS1_PLL,	0,	BUS1_PLL_LOCK,	BUS1_PLL_CON0,	bus1_pll_rates,	TOP_MUX_BUS1_PLL,	&pll141xx_ops);
CLK_PLL(14180,	BUS2_PLL,	0,	BUS2_PLL_LOCK,	BUS2_PLL_CON0,	bus2_pll_rates,	TOP_MUX_BUS2_PLL,	&pll141xx_ops);
CLK_PLL(14170,	BUS3_PLL,	0,	BUS3_PLL_LOCK,	BUS3_PLL_CON0,	bus3_pll_rates,	TOP_MUX_BUS3_PLL,	&pll141xx_ops);
CLK_PLL(14180,	MFC_PLL,	0,	MFC_PLL_LOCK,	MFC_PLL_CON0,	mfc_pll_rates,	TOP_MUX_MFC_PLL,	&pll141xx_ops);
CLK_PLL(14180,	ISP_PLL,	0,	ISP_PLL_LOCK,	ISP_PLL_CON0,	isp_pll_rates,	TOP_MUX_ISP_PLL,	&pll141xx_ops);
CLK_PLL(14180,	DISP_PLL,	0,	DISP_PLL_LOCK,	DISP_PLL_CON0,	disp_pll_rates,	DISP0_MUX_DISP_PLL,	&pll141xx_ops);
CLK_PLL(14310,	AUD_PLL,	0,	AUD_PLL_LOCK,	AUD_PLL_CON0,	aud_pll_rates,	AUD_MUX_AUD_PLL_USER,	&pll1431x_ops);
