...
#define PHYCLKRST_MPLL_MULTIPLIER_26M_REF	(0x60 << 11)
...
#define EXYNOS5_DRD_PHYREG0_SSC_REFCLKSEL_MASK	(0x1ff << 23)
#define EXYNOS5_DRD_PHYREG0_SSC_REFCLKSEL(_x)	((_x) << 23)
#define EXYNOS5_DRD_PHYREG0_SSC_RANGE_MASK	(0x7 << 20)
#define EXYNOS5_DRD_PHYREG0_SSC_RAMGE(_x)	((_x) << 20)
...
void samsung_exynos_cal_usb3phy_crport_handshake(void __iomem *, u32, u32);
void samsung_exynos_cal_usb3phy_crport_ctrl(void __iomem *, u16, u32);
...
#define FSEL_CLKSEL_DIFF_26M		0x82
