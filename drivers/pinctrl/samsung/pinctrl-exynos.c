...
static struct samsung_pin_bank exynos7420_pin_banks2[] = {
	...
	EXYNOS_PIN_BANK_EINTG(bank_type_0, 4, 0x160, "gpd7", 0x2c),
#endif
...
#elif defined(CONFIG_SOC_EXYNOS7890)
	EXYNOS_PIN_BANK_EINTG(bank_type_0, 5, 0x000, "gpr2", 0x00),
	EXYNOS_PIN_BANK_EINTG(bank_type_0, 8, 0x020, "gpr3", 0x04),
	EXYNOS_PIN_BANK_EINTG(bank_type_0, 7, 0x040, "gpr4", 0x08),
#endif
};
